...
class DogsByBreed extends Component {
  ...
  render() {
    ...
    return (
      <View>
        <ScrollView>
          {this.props.dogsByBreed.map(dog => {
            return (
...
const mapStateToProps = state => {
  ...
  return { dogsByBreed: state.dogs.dogsByBreed };
};

const mapDispatchToProps = dispatch => {
  return {
    getDogsByBreed: () => {
      dispatch(getDogsByBreed());
    },
  };
};

const Breed = connect(mapStateToProps, mapDispatchToProps)(DogsByBreed);
